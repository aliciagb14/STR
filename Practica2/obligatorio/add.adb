...
package body add is
   ...
   task Riesgos is 
    ...
    begin
    --para calibrar Time_per_Kwhetstones de tools.adb
    i := clock;
    Execution_Time(Milliseconds(100));
    D := clock - i;
    Kernel.Serial_Output.Put(Duration'Image(To_Duration(D)));
      loop
